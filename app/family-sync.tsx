...
export default function FamilySyncScreen() {
  ...
  const startLogin = async () => {
    ...
    try {
      ...
      if (!result) Alert.alert("Вход", "Вход был отменён. Попробуйте ещё раз, когда будете готовы войти в аккаунт.");
    } catch (error) {
      alertError(error);
    } finally {
